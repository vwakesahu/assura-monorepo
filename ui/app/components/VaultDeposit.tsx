...
export default function VaultDeposit() {
  ...
  const handleConfirmDeposit = async (e?: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      console.log('verifyingData', verifyingData)
      ...
      if (attestedData.score < requiredScore) {
        throw new Error(`Insufficient score. Required: ${requiredScore}, Got: ${attestedData.score}`)
      }

      // Create compliance data using the verification key
