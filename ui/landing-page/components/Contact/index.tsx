...
export default function Contact() {
    ...
    return (
        ...
        >
            <div className="pt-[200px] w-full max-w-[1800px] bg-foreground">
                <div className="border-b border-border/30 pb-[100px] ml-[200px] mr-[200px] relative">
                    <span className="flex items-center">
                        ...
                        <h2 className="ml-[0.3em] text-[5vw] m-0 font-light">Get started</h2>
                    </span>
                    <h2 className="text-[5vw] m-0 font-light">with Assura</h2>
                ...
                <div className="flex gap-5 mt-[100px] ml-[200px] mr-[200px]">
